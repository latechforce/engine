...
import { configAutomationActionServiceCodeRunTypescriptWithDateClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/date'
import { configAutomationActionServiceCodeRunTypescriptWithArrayClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/array'
import { configAutomationActionServiceCodeRunTypescriptWithBooleanClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/boolean'
import { configAutomationActionServiceCodeRunTypescriptWithURLSearchParamsClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/urlSearchParams'
import { configAutomationActionServiceCodeRunTypescriptWithTextEncoderClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/textEncoder'
import { configAutomationActionServiceCodeRunTypescriptWithTextDecoderClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/textDecoder'
import { configAutomationActionServiceCodeRunTypescriptWithBlobClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/blob'
import { configAutomationActionServiceCodeRunTypescriptWithReadableStreamClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/readableStream'
import { configAutomationActionServiceCodeRunTypescriptWithNumberClass } from '/examples/config/automation/action/service/code/runTypescript/withClass/number'
