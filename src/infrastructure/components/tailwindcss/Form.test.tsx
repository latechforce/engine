...
describe('Form', () => {
  it('should match the form snapshot', async () => {
    // GIVEN
    const form = <Form title="Form" action="/form/user" />
  ...
  it('should match the form snapshot with description', async () => {
    // GIVEN
    const form = <Form title="Form" description="Form description" action="/form/user" />
  ...
  it('should match the form snapshot with submit label', async () => {
    // GIVEN
    const form = <Form title="Form" submitLabel="Save" action="/form/user" />
