...
if (!TEST_CALENDLY_ACCESS_TOKEN)
  throw new Error('TEST_CALENDLY_ACCESS_TOKEN env var is not defined')
if (!TEST_CALENDLY_AUTH_BASE_URL)
  throw new Error('TEST_CALENDLY_AUTH_BASE_URL env var is not defined')
