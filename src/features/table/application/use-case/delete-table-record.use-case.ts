...
import type { DeletedRecordDto } from '../dto/deleted-record.dto'

@injectable()
export class DeleteTableRecordUseCase {
  constructor(
    @inject(TYPES.Repository.Record)
    private readonly recordRepository: IRecordRepository
  ) {}

  async execute(app: App, tableId: string, recordId: string): Promise<DeletedRecordDto> {
