...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from './sheet.ui'
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'md:w-[calc(100%-var(--sidebar-width))] md:peer-data-[state=collapsed]:w-[calc(100%-var(--sidebar-width-icon))]',
        className
      )}
      {...props}
    />
