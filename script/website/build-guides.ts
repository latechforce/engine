...
<div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '-1rem', marginBottom: '1rem' }}>
  <a href="https://github.com/latechforce/engine/edit/main/example/${guide.path}.ts" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.8rem', color: 'var(--ifm-color-emphasis-600)', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
