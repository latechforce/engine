...
description: "Changelog for version 0.51.0"
slug: "release-0-51-0"
date: 2025-06-04
tags: [release]
---

<p class="before-truncate"> 0.51.0   Features  * action: should run action with env variables in inputData (77cae6e) — Thomas JEANNEAU * action: should run action with inputData parsed in JSON (70e53ed) — Thomas JEANNEAU * mocks: export mocks for app testing (969e33e) — Thomas JEANNEAU   0.50.1   Bug Fixes  * export types fro...</p>
