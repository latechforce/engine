---
title: "Fix 0.58.3"
description: "Changelog for version 0.58.3"
slug: "fix-0-58-3"
date: 2025-06-22
tags: [fix]
---

<p class="before-truncate"> 0.58.3   Bug Fixes  * action: fix bad template filling in setup (c3a6d3b) — Thomas JEANNEAU   0.58.2   Bug Fixes  * trigger: should trigger an automation with form data (bd2ddda) — Thomas JEANNEAU   0.58.1   Bug Fixes  * temaplte: should fill a template with a regex helper and extract the first mat...</p>
