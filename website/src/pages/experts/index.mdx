...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '2.5rem', alignItems: 'flex-start', justifyContent: 'space-between', padding: '2rem 0 2.5rem 0' }}>
  <div style={{ flex: '1 1 340px', minWidth: '320px', maxWidth: '480px' }}>
    <div style={{ fontSize: '2.3rem', fontWeight: 700, color: 'var(--ifm-color-emphasis-900)', lineHeight: 1.1, marginBottom: '1.5rem' }}>
      We listen to you.<br />
      We advise you.<br />
      We develop.<br />
      We adjust.<br />
      We maintain.<br />
      <span style={{ color: 'var(--ifm-color-primary)', fontWeight: 800 }}>You are satisfied.</span>
    </div>

    <p style={{ fontSize: '1.1rem', color: 'var(--ifm-color-emphasis-700)', marginBottom: '1.2rem' }}>
