...
test.describe('POST /api/automation/:path', () => {
  test('should run a TypeScript code', async ({ startExampleApp }) => {
    // GIVEN
    const page = await startExampleApp({ filter: 'automation/action/code/run-typescript' })
  ...
  test('should run a TypeScript code with input data', async ({ startExampleApp }) => {
    ...
    const page = await startExampleApp({
      filter: 'automation/action/code/run-typescript/input-data',
    })
  ...
  test('should return an error when the code throw an error', async ({ startExampleApp }) => {
    // GIVEN
    const page = await startExampleApp({ filter: 'automation/action/code/run-typescript/error' })
  ...
  test('should run a TypeScript code with externals', async ({ startExampleApp }) => {
    // GIVEN
    const page = await startExampleApp({
      filter: 'automation/action/code/run-typescript/externals',
    })
  ...
  test('should run a TypeScript code with globals variables', async ({ startExampleApp }) => {
    // GIVEN
    const page = await startExampleApp({ filter: 'automation/action/code/run-typescript/globals' })
  ...
  test('should return an error when the code is invalid', async ({ startExampleApp }) => {
    ...
    const call = () =>
      startExampleApp({
        filter: 'automation/action/code/run-typescript/syntax-error',
      })
